<template>
	<view class="abl">
		...
		<view class="abl_b">
			<view class="abl_b1" @click="navTo('/pages/ad/myAd/adBalance/adBalanceSale?m=' + wallet.adCardNum)">
				<view class="abl_b1_m">
					出售广告卡
				</view>
			</view>
	...
	export default {
		...
		methods: {
			...
			async loadDataList(e) {
				const res = await this.$get('/user-money-log/listAdLog', {
					currentPage: e.num,
					pageSize: e.size,
				}, {}, () => {
