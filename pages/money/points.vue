	...
	<view class="abl">
		<view class="abl_t w_flex_center">
			<view class="abl_t_s ablts_l">
				<view class="abl_t_s_t">{{wallet.points}}</view>
				<view class="abl_t_s_b">可用积分</view>
			</view>
		</view>
		<view class="abl_m">
			<view class="abl_m_t">积分明细</view>
			<view class="abl_m_m">
				<mescroll-uni height="75%" :bottombar="false" ref="mescrollRef" @init="mescrollInit"
	...
	export default {
		...
		methods: {
			...
			async loadDataList(e) {
				const res = await this.$get('/user-money-log/listPointsLog', {
					currentPage: e.num,
					pageSize: e.size,
				}, {}, () => {
