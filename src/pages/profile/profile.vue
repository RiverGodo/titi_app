		...
		<view class="user-info">
			...
			<view class="info-item">
				...
				<view v-if="!nameEditOn" class="info">
					...
					<u-icon class="btn" name="edit-pen" @click="
            ...
            "></u-icon>
				...
				<view v-else class="name-edit">
					...
					<view class="edit-btn-group">
						<u-tag class="edit-btn" text="保存" plain size="mini" type="primary" @click="handleSaveBtnClick">
						</u-tag>
						<u-tag class="edit-btn" text="取消" plain size="mini" type="info" @click="
                tempName = ''
                nameEditOn = false
              "></u-tag>
					</view>
			...
			<view class="info-item">
				<view class="label">等级头衔：</view>
				<view class="info">
					<view class="value">NFT{{forMateLevel(userInfo.integralBalance)}}</view>
					<!-- <u-icon class="btn" name="edit-pen"></u-icon> -->
				</view>
			</view>
			<view class="info-item">
				...
				<view class="info">
					<view class="value">{{ userInfo.cashBalance }}</view>
					<!-- <u-icon class="btn" name="edit-pen"></u-icon> -->
				</view>
			</view>
			<view class="info-item">
				...
				<view class="info">
					<view class="value">{{ userInfo.integralBalance }}</view>
					<!-- <u-icon class="btn" name="edit-pen"></u-icon> -->
				</view>
			</view>
			<view class="info-item">
				<view class="label">碳值：</view>
				<view class="info">
					<view class="value">{{ userInfo.tbBalance }}</view>
					<!-- <u-icon class="btn" name="edit-pen"></u-icon> -->
				</view>
			</view>
			<view class="info-item">
				...
				<view class="info">
					<view class="value">{{ userInfo.bondBalance }}</view>
					<!-- <u-icon class="btn" name="edit-pen"></u-icon> -->
				</view>
			</view>
		</view>
