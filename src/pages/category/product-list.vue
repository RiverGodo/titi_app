<template>
  <view class="container">
    <u-navbar :title="title" :autoBack="true" titleStyle="font-size: 28rpx">
    </u-navbar>
    <view class="context">
      <view class="tabs-top">
      ...
      <scroll-view scroll-y="true" class="product-list" enable-flex="true">
        <view class="flex-box">
          <block v-for="(item, index) in productList[current]" :key="index">
            <view @click="handleBuy(item.id)" class="product-item">
              ...
              <view class="product-button">
                ...
                <view class="product-price-button">
                  ...
                  <text class="product-like-ccount">销量 {{ item.totalStock }}</text>
                </view>
              </view>
            </view>
          </block>
