	...
	<view class="abg">
		<view :style="'background-image: url('+ backImg +');'" class="abg_t">
			<view class="abg_t_t">
				...
				<view class="abg_t_t_b">可转赠数量</view>
			</view>
			<view class="abg_t_m">
				<view class="abg_t_m_s">
					<view class="abg_t_m_s_t">转赠数量</view>
					<view class="abg_t_m_s_i disabled">
	...
	export default {
		...
		methods: {
			...
			async confirm(){
				...
				let res = await this.$post('/seller/ad-gave-order/send', {sellerId: this.sellerId})
				this.$util.msg("转赠成功");
				setTimeout(() => {
					this.back();
				}, 1000)
