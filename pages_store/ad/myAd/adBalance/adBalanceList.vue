	...
	<view class="abl">
		<view class="abl_t w_flex_center">
			<view class="abl_t_s ablts_l">
				<view class="abl_t_s_t">{{wallet.adCardNum}}</view>
				<view class="abl_t_s_b">可用广告卡（张）</view>
			</view>
			<view class="abl_t_s ablts_r">
				<view class="abl_t_s_t">{{wallet.adCardGaveNum}}</view>
				<view class="abl_t_s_b">冻结广告卡（张）</view>
			</view>
		</view>
		<view class="abl_m">
			<view class="abl_m_t">广告卡明细</view>
			<view class="abl_m_m">
		...
		<view class="abl_b">
			<view class="abl_b1" v-if="wallet.type===0"
				@click="navTo('/pages_store/ad/myAd/adBalance/adBalanceSale?m=' + wallet.adCardNum,{login: true})">
				<view class="abl_b1_m">
					出售广告卡
				</view>
			</view>
			<view class="abl_b2" v-else>
				<view class="abl_b2_m w_flex_center">
					<view
						@click="navTo('/pages_store/ad/myAd/adBalance/adBalanceSale?m=' + wallet.adCardNum,{login: true})"
						class="abl_b2_m_l">出售广告卡</view>
					<view
						@click="navTo('/pages_store/ad/myAd/adBalance/adBalanceGive?m='+ wallet.adCardNum,{login: true})"
						class="abl_b2_m_r">转赠广告卡</view>
				</view>
			</view>
		</view>
	</view>
	...
	export default {
		...
		methods: {
			...
			async loadDataList(e) {
				const res = await this.$get('/seller/seller-money-log/listAdLog', {
					currentPage: e.num,
					pageSize: e.size,
				}, {}, () => {
