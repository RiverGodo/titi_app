		...
		<view :style="'background-image: url('+ backImg +');background-repeat: no-repeat;'" class="mcd_b">
			...
			<view class="mcd_m1">
				<view class="mcd_m1_t w_flex_start">
					...
					<view class="mcd_m1_t_r">
						...
						<view class="mcd_m1_t_r_b">{{cashDetial.money}}现金豆</view>
					</view>
				</view>
				<view class="mcd_m1_b">
					小计（现金豆）：<text style="color: #FC5531;font-size: 32rpx;">{{cashDetial.money}}</text>
				</view>
			</view>
			<view class="mcd_m2">
			...
			<view class="mcd_m3">
				...
				<view class="mcd_m3_s w_flex_start">
					...
					<view class="mcd_m3_s_r">现金豆兑换</view>
				</view>
				<view class="mcd_m3_s w_flex_start">
				...
				<view class="mcd_m3_s w_flex_start">
					...
					<view class="mcd_m3_s_r">{{cashDetial.money}}(现金豆)</view>
				</view>
				<view class="mcd_m3_s w_flex_start">
				...
				<view class="mcd_m3_b">
					应付现金豆：<text style="color: #FC5531;">{{cashDetial.money}}</text>
				</view>
			</view>
